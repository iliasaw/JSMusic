...
module.exports = {
  name: "grab",
  description: "Сохраняет текущую песню в ваших личных сообщениях",
  usage: "",
  permissions: {
    ...
    message.author
      .send(
        new MessageEmbed()
          ...
          .setFooter(
            `Запрошенно: ${player.queue.current.requester.tag}`,
      ...
      .catch((e) => {
        return message.channel.send("**:x: Ваши личные сообщения отключены**");
      });

    client.sendTime(message.channel, "✅ | **Проверьте свои личные сообщения!**");
  },
  SlashCommand: {
    /**
     *
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      try {
        ...
        return client.sendTime(interaction, "**:x: Ваши личные сообщения отключены**");
      }

      client.sendTime(interaction, "✅ | **Проверьте свои личные сообщения!**");
    },
  },
};
